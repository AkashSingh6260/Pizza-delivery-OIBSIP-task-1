...
// Google OAuth Strategy - wrapped in try-catch to handle missing credentials
try {
  passport.use(
    new GoogleStrategy(
      {
  ...
  console.warn("Google OAuth strategy not available:", err.message);
}

// Facebook OAuth Strategy - wrapped in try-catch to handle missing credentials
try {
  passport.use(
  ...
  console.warn("Facebook OAuth strategy not available:", err.message);
}
